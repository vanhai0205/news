                ...
                <div id="home" class="tab-pane fade in active">
                  <h3>Nhập dữ liệu</h3>
                    <form class="form-horizontal"  method="POST" >
                        ...
                        <div class="col-sm-10">
                          <input name="name" value="<?=$data->name?>" type="text" class="form-control" id="title">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input name="mail" value="<?=$data->mail?>" type="text" class="form-control" id="title">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input name="acc" value="<?=$data->acc?>" type="text" class="form-control" id="title">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input name="pass" value="<?=$data->pass?>" type="text" class="form-control" id="title">
                        </div>
                      </div>
                      <div  class="form-group">
                        ...
                        <label class="radio-inline"><input value="1" name="status" type="radio" checked="checked">Admin</label>
                        <label class="radio-inline"><input value="0" name="status" type="radio" >Đọc giả</label>
                          <?php else: ?>
					  ...
					  <div class="form-group"> 
                        <div class="col-sm-offset-2 col-sm-10">
                          <button name="edit_user" type="submit" class="btn btn-primary">Hoàn tất</button>
                        </div>
                      </div>
				</div>
