 <div class="container">
                          ...
                          <table class="table table-striped" style="margin-top: 30px">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><?=$n->name?></td>
                                <td><?=$n->title?></td>
                                <td><img width="50px" src="../upload/<?=$n->img?>"></td>
                                <td><?=$n->ndesc?></td>
                                <td>
                                  <?php if($n->status == 1):?> 
  ...
  elseif ($page > $totalPage) {
    ...
    for ($i=1; $i <= $totalPage ; $i++) { 
      if($i == $page){
        echo '<li class="active"><a href = "index.php?com=tintuc&act=list&page='.$i.'" >'.$i.'</li>';
      }
      else{
        echo '<li><a href = "index.php?com=tintuc&act=list&page='.$i.'" >'.$i.'</li>';
      }
    }
  }
