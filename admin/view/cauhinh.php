        ...
        <table class="table table-bordered" style="background: #f9f9f9">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="12">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="email" value="<?=$data->email?>" type="text" class="form-control" id="title">
                  </div>
                </div>
              </td>
            ...
            <tr>
              <td colspan="12">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="dienthoai" value="<?=$data->dienthoai?>" type="text" class="form-control" id="title">
                  </div>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="12">
                <div class="form-group">
                  <label class="control-label col-sm-2" for="title">Website</label>
                  <div class="col-sm-10">
                    <input name="web" value="<?=$data->web?>" type="text" class="form-control" id="title">
                  </div>
                </div>
              </td>
            ...
            <tr>
              <td colspan="12">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="fanpage" value="<?=$data->fanpage?>" type="text" class="form-control" id="title">
                  </div>
                </div>
              </td>
            ...
            <tr>
              <td colspan="12">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="titleseo" value="<?=$data->titleseo?>" type="text" class="form-control" id="title">
                  </div>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="12">
                <div class="form-group" >
                  ...
                  <div class="col-sm-10" >
                    <textarea name="keyseo" rows="10" class="form-control" id="desc"><?=$data->keyseo?></textarea>
                  </div>
                </div>
              </td>
            ...
            <tr>
              <td colspan="12">
                <div class="form-group" >
                  ...
                  <div class="col-sm-10" >
                    <textarea name="descseo"  rows="10" class="form-control" id="desc"><?=$data->descseo?></textarea>
                  </div>
                </div>
              </td>
            ...
            <tr>
              <td colspan="12">
                <div class="form-group" >
                  ...
                  <div class="col-sm-10" >
                    <textarea name="ana"  rows="10" class="form-control" id="desc"><?=$data->ana?></textarea>
                  </div>
                </div>
              </td>
            ...
            <tr>
              <td colspan="12">
                <div class="form-group" >
                  ...
                  <div class="col-sm-10" >
                    <textarea name="map" rows="10" class="form-control" id="desc"><?=$data->map?></textarea>
                  </div>
                </div>
              </td>
